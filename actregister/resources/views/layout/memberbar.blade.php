...
{{-- navbar-expand-sm 寬度大於等於 576 像素會擴展 --}}
<nav class="navbar navbar-expand-sm fixed-top ">
    <div class="container-fluid ">

        <div class="col-2"></div>
        <a class="navbar-brand baradjust" href="#">KSB</a>
        <span class="fs-6 baradjust">歡迎來到卡司比報名網。
        </span>
        ...
        <span class="fs-6 baradjust">{{ session('mySessionVariable') }}
        </span>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h6 class="modal-title col-6 text-start" style="color: red">若尚未有帳號請先註冊</h6>
